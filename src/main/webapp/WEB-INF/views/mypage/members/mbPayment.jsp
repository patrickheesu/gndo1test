...
<body>
      ...
      <div class="accordion-item">
        ...
        <div id="s${status.count }" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
          <div class="accordion-body" id="contentaccor">
	            <h3>결제 내역</h3> <br />
    <li><b>예약 업소명</b> : ${dto.acc.acc_name } </li>
	<li><b>업소전화번호</b> : ${dto.acc.acc_tel } </li>
	<li><b>업소 주소</b> : ${dto.acc.acc_map } &nbsp;${dto.acc.acc_detailmap } </li>
	...
	<a href="cancel?pm_num=${dto.pay.pm_num }"><button>예약·결제 취소</button></a>
          </div>
        </div>
        </c:forEach>
      </div>      
