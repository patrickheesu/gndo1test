...
<body style="text-align: center;">
    <div class="memberbody">
        <div class="memberprofile">
            <div class="userprofile">
                ...
                <a>
               		<div>
                    	<div class="userprofile_nickname">${cpy_name }님</div>
					</div>
						 <br>
                    <div class="userprofile_email">${cpy_email }</div>
               		</div>
                </a>
            </div>
        </div>
    ...
    <div class="memberinfo" style="align-items: center;">
		...
		<div class="memuid">
			...
			<div class="userid">${cpy_id }</div><br />
		</div>
		<div class="memuemail">
			<div class="memberemail">이메일</div>
			<div class="useremail">${cpy_email }</div><br />
		</div>
	...
	$.ajax({
		...
		success : function(result) {
			if (result == 'false') {
				...
				$.ajax({
				    type : 'post' ,
			   	    url : '<%=path%>/myPage/wocpy',
			   	 	async : false ,
					dataType : 'text',
					success : function(result) {
						if (result == 'true') {
							alert("회원탈퇴가 완료되셨습니다!");
							console.log("without company success");
							location.href='';
						} else {
							alert("로그아웃 되었습니다.");
							console.log("logout");
