...
<div class="logo"><img src="resources/img/mypage/company/로고1.png" alt="" width="150" height="150">
    <h1>업소등록</h1>
    <hr> <br>
    <form action="cpRoomInsert" id="form" method="post"   enctype="multipart/form-data">
    	...
    	<table>
    		...
    		<tr>
    			<td><b>주소</b></td>
    			<td><input type="text" name="zipcode" id="zipcode" placeholder="우편번호" onfocus="this.placeholder=''" onblur="this.placeholder='우편번호'"><input type="button" onclick="addrsearch();" value="주소 검색"> <br />
            
             <input type="text"  id="address1" name="address1" width="250;" value="dd"> <br> 
...
<!--     		</tr> -->
    		<tr>
    			<td><b>유선 전화번호</b></td>
    			<td><input type="tel" name="acc_tel" placeholder="ex)033-123-1234 " onfocus="this.placeholder=''" onblur="this.placeholder='ex)033-123-1234'"></td>
    		</tr>
    		<tr>
    			<td><b>기본 정보</b></td>
    			<td><textarea name="acc_info" rows="10" cols="30"></textarea></td>
    		</tr>
    		<tr>
    			<td><b>검색키워드</b></td>
    			<td><textarea name="acc_serkeyword" rows="10" cols="30"></textarea></td>
    		</tr>
    		<tr>
    			<td><b>사진 추가하기</b></td>
