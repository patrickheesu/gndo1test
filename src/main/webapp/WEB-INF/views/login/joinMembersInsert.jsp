...
<body>
    ...
    <form name="join" action="joinMem" method="post" onsubmit="return jcSubmit()">
        <table class="join">
            ...
            <tr>
            	<td></td>
            	<td><span id="check_birth" class="check_birth"></span></td>
            </tr>
            <tr>
                <td>닉네임*</td>
                <td><input type="text" id="mem_nickname" name="mem_nickname" placeholder="닉네임 입력"></td>
                <td><input type="button" class="checkNk_bt" name="checkNk_bt" value="중복검사" onclick="duplicateCheck2();" /></td>
            </tr>
            <tr>
				<td></td>
				<td><hr /></td>
            ...
            <tr>
            	<td></td>
            	<td><span id="check_nick" class="check_nick"></span></td>
            </tr>
            <tr>
                <td>성별*</td>
                <td>
            ...
            <tr>
                <td>주소(선택)</td>
                <td><input type="text" name="mem_addr1" id="mem_addr1" placeholder="우편주소 검색" onclick="findAddr()" readonly></td>
                <td></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
                <td></td>
                <td><input type="text" name="mem_addr2" id="mem_addr2" readonly placeholder="주소"></td>
                <td></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
                <td></td>
                <td><input type="text" name="mem_addr3" id="mem_addr3" placeholder="상세주소 입력"></td>
                <td></td>
			</tr>
			<tr>
				<td></td>
...
function mnameCheck(){
	var mn = $("#mem_name").val();
	var mmn = document.getElementById("check_mn");
	var mnCheck = /^[가-힣]{2,6}$/;
	if(!mn){
