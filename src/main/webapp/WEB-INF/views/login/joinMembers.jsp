...
<body>
    ...
    <form action="joinMembersInsert" id="joinForm" name="form">
        <ul>
            ...
            <li>
                <textarea class="textarea" name="" id="" cols="100" rows="20">제1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
